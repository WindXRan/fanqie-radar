...
- **书卡流**（主视图）：双列封面卡片——封面 / 书名 / 作者·品类 / 在读大字 / 徽章（完结·字数·套路命中）/ 简介前两行
- **快筛工具条**：搜索（书名/作者/简介）· 品类下拉 · 状态与在读门槛 chips · 按在读 / 官方名次（番茄品类内名次）排序
- **人类动线**：点书名看完整简介 → 点热词筛同套路书 → 点题材热度条筛品类 → 点 ☆ 收藏候选（localStorage 持久化，侧栏清单）
